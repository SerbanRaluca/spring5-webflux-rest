...
public class VendorControllerTest extends TestCase {
    ...
    public void testList() {
        given(vendorRepository.findAll())
                .willReturn(Flux.just(Vendor.builder().firstName("f1").lastName("l1").build(),
                        Vendor.builder().firstName("f2").lastName("l2").build()));
    ...
    public void testGetById() {
        ...
        given(vendorRepository.findById("someId"))
                .willReturn(Mono.just(Vendor.builder().firstName("f1").lastName("l1").build()));
